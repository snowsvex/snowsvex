/* src/articles/test.svx generated by Svelte v3.34.0 */
import {
	SvelteComponentDev,
	add_location,
	append_dev,
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 5, 0, 118);
			add_location(p, file, 7, 0, 150);
			add_location(blockquote, file, 6, 0, 137);
		},
...
const metadata = { "title": "Awesome title" };
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ metadata, title });
	return [];
}
